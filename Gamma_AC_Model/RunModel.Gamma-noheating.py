...
import torch  # Import PyTorch AFTER setting the environment variables
...
#
shape = torch.load(prepath+'shape_noheating.pt')
scale = torch.load(prepath+'scale_noheating.pt')
#
